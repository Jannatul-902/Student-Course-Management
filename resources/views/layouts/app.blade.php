...
<head>
    ...
    <style>
        ...
        /* Main content flex-grow করবে যাতে footer সবসময় নিচে থাকে */
        .content {
            flex: 1;
        }
    </style>
...
<body class="bg-light text-dark">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-HoA2p+G5LFf2s/t5WeOmCStKF55O/7MnpKp1F7IdcdURlN1TmtxIMws7t4ycw9Mc" crossorigin="anonymous">
    </script>
